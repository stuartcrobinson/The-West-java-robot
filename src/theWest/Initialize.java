...
//		users.add(new User("jellybean wine", "jellybean wine", null, null));
		...
		users.add(new User("one two three", 		"one",		Skill.Trading, 		 Attribute.Charisma, 	Job.EXPERIENCE));
		...
		users.add(new User("jellybean wine", "jellybean wine",	Job.ALL_THREE)); 
		users.add(new User("tall grass",	 "tall grass", 		Job.ALL_THREE)); 
		users.add(new User("culculpraline",	 "swimming", 		Job.ALL_THREE)); 
		users.add(new User("suzy marie",	 "suzy marie", 		Job.ALL_THREE)); 
		users.add(new User("25 daniels",	 "25 daniels",		Job.ALL_THREE));
